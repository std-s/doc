...
| 参数名称    | 参数类型                                                       | 是否必填 | 描述     |
| ----------- | -------------------------------------------------------------- | -------- | -------- |
| searchParam | [OIMSearchUserParam](docs/sdks/Class/User/SearchUserParam.mdx) | 是       | 搜索参数 |

### 返回结果

| 参数名称  | 参数类型                                                                  | 描述     |
| --------- | ------------------------------------------------------------------------- | -------- |
| onSuccess | [OIMSearchUsersInfoCallback](docs/sdks/Callback/FullUserInfoCallback.mdx) | 成功返回 |
